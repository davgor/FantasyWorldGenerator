...
[SCALE-METRE-CONSTANTS-COLLAPSE](SCALE-METRE-CONSTANTS-COLLAPSE.md) records.

## Not owned

Pre-existing. Surfaced by the biome-reachability sweep of 2026-09-20. Related:
[PRODUCT-REACHABILITY-REPORT](PRODUCT-REACHABILITY-REPORT.md), which raises the general form —
