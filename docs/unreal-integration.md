...
There is currently no portable C++ kernel, `.uplugin`, C++/Blueprint importer, cooked-runtime generator, save migration, or Unreal validation in this repository. JSON export is not the intended live packaged-game runtime. Those capabilities require ML-01–03 contracts, native conformance, and a separately tested minimal consumer.
