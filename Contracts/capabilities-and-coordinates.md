...
The future adapter must record its target axis mapping, handedness, origin/rebasing and triangle winding and validate them in the connected engine project. Scaling alone does not select an Unreal orientation or prove that an imported mesh faces outward. No target-axis mapping, importer, native runtime or cooked consumer is implemented by ML-01b.
